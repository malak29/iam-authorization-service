...
public class AuthorizationExceptionHandler {
    ...
    public Mono<ResponseEntity<ApiResponse<Void>>> handleNotFound(CustomExceptions.UserNotFoundException ex) {
    ...
    public Mono<ResponseEntity<ApiResponse<Void>>> handleDataIntegrityViolation(DataIntegrityViolationException ex) {
        ...
        return Mono.just(ResponseEntity.status(HttpStatus.CONFLICT)
                .body(ApiResponse.error("Data integrity violation - check for duplicate values")));
    }
